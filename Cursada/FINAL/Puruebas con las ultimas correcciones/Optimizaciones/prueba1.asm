...
b@Variable@main DD ?
var@@aux30 DD ?
cadena@@278 DB "Optimiza 1", 0
cadena@@279 DB "Error 1", 0
cadena@@280 DB "Optimiza 2", 0
cadena@@281 DB "Error 2", 0
cadena@@282 DB "Optimiza 3", 0
cadena@@283 DB "Error 3", 0
cadena@@284 DB "Optimiza 4", 0
cadena@@285 DB "Error 4", 0
cadena@@286 DB "Nunca llega if", 0
cadena@@287 DB "nunca llega else", 0
.code
_division_cero:
