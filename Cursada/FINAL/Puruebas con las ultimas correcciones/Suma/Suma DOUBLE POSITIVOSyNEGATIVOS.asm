...
cadena@@534 DB "Suma var = -cte anda Double", 0
cadena@@535 DB "Suma var = -cte no anda Double", 0
cadena@@536 DB "Suma var+var = -cte anda Double", 0
cadena@@537 DB "Suma var+var = -cte no anda Double", 0
cadena@@538 DB "Suma var+-cte = cte anda Double", 0
cadena@@539 DB "Suma var+-cte = cte no anda Double", 0
cadena@@540 DB "Suma -cte+var = -cte anda Double", 0
cadena@@541 DB "Suma -cte+var = -cte no anda Double", 0
cadena@@542 DB "Suma -cte+-cte = -cte anda Double", 0
cadena@@543 DB "Suma -cte+-cte = -cte no anda Double", 0
cadena@@544 DB "Suma var+fn = -cte anda Double", 0
cadena@@545 DB "Suma var+fn = -cte no anda Double", 0
cadena@@546 DB "Suma fn+var = -cte anda Double", 0
cadena@@547 DB "Suma fn+var = -cte no anda Double", 0
cadena@@548 DB "Suma -cte+fn = -cte anda Double", 0
cadena@@549 DB "Suma -cte+fn = -cte no anda Double", 0
cadena@@550 DB "Suma fn+cte = -cte anda Double", 0
cadena@@551 DB "Suma fn+cte = -cte no anda Double", 0
cadena@@552 DB "Suma fn+fn = -cte anda Double", 0
cadena@@553 DB "Suma fn+fn = -cte no anda Double", 0
cadena@@554 DB "Suma var+fn = var anda Double", 0
cadena@@555 DB "Suma var+fn = var no anda Double", 0
cadena@@556 DB "Suma -cte+cte = fn anda Double", 0
cadena@@557 DB "Suma -cte+cte = fn no anda Double", 0
const@@3_0 DQ 3.0
const@@_10_0 DQ -10.0
const@@_7_0 DQ -7.0
aux_mem_2bytes DW ?
