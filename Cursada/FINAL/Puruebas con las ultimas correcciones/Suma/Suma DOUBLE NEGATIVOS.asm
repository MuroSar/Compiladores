...
var@@aux73 DQ ?
var@@aux31 DQ ?
cadena@@458 DB "Suma var = -cte anda Double", 0
cadena@@459 DB "Suma var = -cte no anda Double", 0
cadena@@460 DB "Suma var+var = -cte anda Double", 0
cadena@@461 DB "Suma var+var = -cte no anda Double", 0
cadena@@462 DB "Suma var+-cte = -cte anda Double", 0
cadena@@463 DB "Suma var+-cte = -cte no anda Double", 0
cadena@@464 DB "Suma -cte+var = -cte anda Double", 0
cadena@@465 DB "Suma -cte+var = -cte no anda Double", 0
cadena@@466 DB "Suma -cte+-cte = -cte anda Double", 0
cadena@@467 DB "Suma -cte+-cte = -cte no anda Double", 0
cadena@@468 DB "Suma var+fn = -cte anda Double", 0
cadena@@469 DB "Suma var+fn = -cte no anda Double", 0
cadena@@470 DB "Suma fn+var = -cte anda Double", 0
cadena@@471 DB "Suma fn+var = -cte no anda Double", 0
cadena@@472 DB "Suma -cte+fn = -cte anda Double", 0
cadena@@473 DB "Suma -cte+fn = -cte no anda Double", 0
cadena@@474 DB "Suma fn+-cte = -cte anda Double", 0
cadena@@475 DB "Suma fn+-cte = -cte no anda Double", 0
cadena@@476 DB "Suma fn+fn = -cte anda Double", 0
cadena@@477 DB "Suma fn+fn = -cte no anda Double", 0
cadena@@478 DB "Suma var+fn = var anda Double", 0
cadena@@479 DB "Suma var+fn = var no anda Double", 0
cadena@@480 DB "Suma -cte+-cte = fn anda Double", 0
cadena@@481 DB "Suma -cte+-cte = fn no anda Double", 0
const@@_3_0 DQ -3.0
const@@_10_0 DQ -10.0
const@@_13_0 DQ -13.0
aux_mem_2bytes DW ?
