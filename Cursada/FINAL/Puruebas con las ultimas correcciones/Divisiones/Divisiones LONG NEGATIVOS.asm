...
var@@aux73 DD ?
var@@aux31 DD ?
cadena@@52 DB "Division var = cte anda Long", 0
cadena@@53 DB "Division var = cte no anda Long", 0
cadena@@54 DB "Division var/var = cte anda Long", 0
cadena@@55 DB "Division var/var = cte no anda Long", 0
cadena@@56 DB "Division var/cte = cte anda Long", 0
cadena@@57 DB "Division var/cte = cte no anda Long", 0
cadena@@58 DB "Division cte/var = cte anda Long", 0
cadena@@59 DB "Division cte/var = cte no anda Long", 0
cadena@@60 DB "Division cte/cte = cte anda Long", 0
cadena@@61 DB "Division cte/cte = cte no anda Long", 0
cadena@@62 DB "Division var/fn = cte anda Long", 0
cadena@@63 DB "Division var/fn = cte no anda Long", 0
cadena@@64 DB "Division fn/var = cte anda Long", 0
cadena@@65 DB "Division fn/var = cte no anda Long", 0
cadena@@66 DB "Division cte/fn = cte anda Long", 0
cadena@@67 DB "Division cte/fn = cte no anda Long", 0
cadena@@68 DB "Division fn/cte = cte anda Long", 0
cadena@@69 DB "Division fn/cte = cte no anda Long", 0
cadena@@70 DB "Division fn/fn = cte anda Long", 0
cadena@@71 DB "Division fn/fn = cte no anda Long", 0
cadena@@72 DB "Division var/fn = var anda Long", 0
cadena@@73 DB "Division var/fn = var no anda Long", 0
cadena@@74 DB "Division cte/-cte = fn anda Long", 0
cadena@@75 DB "Division cte/-cte = fn no anda Long", 0
cadena@@76 DB "Division por cero no anda Long", 0
cadena@@77 DB "Division no anda Long", 0
.code
_division_cero:
