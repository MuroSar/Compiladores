...
var@@aux73 DD ?
var@@aux31 DD ?
cadena@@78 DB "Suma var = cte anda Long", 0
cadena@@79 DB "Suma var = cte no anda Long", 0
cadena@@80 DB "Suma var+var = cte anda Long", 0
cadena@@81 DB "Suma var+var = cte no anda Long", 0
cadena@@82 DB "Suma var+cte = cte anda Long", 0
cadena@@83 DB "Suma var+cte = cte no anda Long", 0
cadena@@84 DB "Suma cte+var = cte anda Long", 0
cadena@@85 DB "Suma cte+var = cte no anda Long", 0
cadena@@86 DB "Suma cte+cte = cte anda Long", 0
cadena@@87 DB "Suma cte+cte = cte no anda Long", 0
cadena@@88 DB "Suma var+fn = cte anda Long", 0
cadena@@89 DB "Suma var+fn = cte no anda Long", 0
cadena@@90 DB "Suma fn+var = cte anda Long", 0
cadena@@91 DB "Suma fn+var = cte no anda Long", 0
cadena@@92 DB "Suma cte+fn = cte anda Long", 0
cadena@@93 DB "Suma cte+fn = cte no anda Long", 0
cadena@@94 DB "Suma fn+cte = cte anda Long", 0
cadena@@95 DB "Suma fn+cte = cte no anda Long", 0
cadena@@96 DB "Suma fn+fn = cte anda Long", 0
cadena@@97 DB "Suma fn+fn = cte no anda Long", 0
cadena@@98 DB "Suma var+fn = var anda Long", 0
cadena@@99 DB "Suma var+fn = var no anda Long", 0
cadena@@100 DB "Suma cte+cte = fn anda Long", 0
cadena@@101 DB "Suma cte+cte = fn no anda Long", 0
.code
_division_cero:
