...
var@@aux73 DQ ?
var@@aux31 DQ ?
cadena@@512 DB "Suma var = cte anda Double", 0
cadena@@513 DB "Suma var = cte no anda Double", 0
cadena@@514 DB "Suma var+var = cte anda Double", 0
cadena@@515 DB "Suma var+var = cte no anda Double", 0
cadena@@516 DB "Suma var+cte = cte anda Double", 0
cadena@@517 DB "Suma var+cte = cte no anda Double", 0
cadena@@518 DB "Suma cte+var = cte anda Double", 0
cadena@@519 DB "Suma cte+var = cte no anda Double", 0
cadena@@520 DB "Suma cte+cte = cte anda Double", 0
cadena@@521 DB "Suma cte+cte = cte no anda Double", 0
cadena@@522 DB "Suma var+fn = cte anda Double", 0
cadena@@523 DB "Suma var+fn = cte no anda Double", 0
cadena@@524 DB "Suma fn+var = cte anda Double", 0
cadena@@525 DB "Suma fn+var = cte no anda Double", 0
cadena@@526 DB "Suma cte+fn = cte anda Double", 0
cadena@@527 DB "Suma cte+fn = cte no anda Double", 0
cadena@@528 DB "Suma fn+cte = cte anda Double", 0
cadena@@529 DB "Suma fn+cte = cte no anda Double", 0
cadena@@530 DB "Suma fn+fn = cte anda Double", 0
cadena@@531 DB "Suma fn+fn = cte no anda Double", 0
cadena@@532 DB "Suma var+fn = var anda Double", 0
cadena@@533 DB "Suma var+fn = var no anda Double", 0
cadena@@534 DB "Suma cte+cte = fn anda Double", 0
cadena@@535 DB "Suma cte+cte = fn no anda Double", 0
const@@3_0 DQ 3.0
const@@10_0 DQ 10.0
const@@13_0 DQ 13.0
aux_mem_2bytes DW ?
