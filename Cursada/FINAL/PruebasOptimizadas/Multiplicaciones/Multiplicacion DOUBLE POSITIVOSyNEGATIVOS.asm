...
var@@aux73 DQ ?
var@@aux31 DQ ?
cadena@@50 DB "Multiplicación var = -cte anda Double", 0
cadena@@51 DB "Multiplicación var = -cte no anda Double", 0
cadena@@52 DB "Multiplicación var*var = -cte anda Double", 0
cadena@@53 DB "Multiplicación var*var = -cte no anda Double", 0
cadena@@54 DB "Multiplicación var*cte = -cte anda Double", 0
cadena@@55 DB "Multiplicación var*cte = -cte no anda Double", 0
cadena@@56 DB "Multiplicación -cte*var = -cte anda Double", 0
cadena@@57 DB "Multiplicación -cte*var = -cte no anda Double", 0
cadena@@58 DB "Multiplicación cte*-cte = -cte anda Double", 0
cadena@@59 DB "Multiplicación cte*-cte = -cte no anda Double", 0
cadena@@60 DB "Multiplicación var*fn = -cte anda Double", 0
cadena@@61 DB "Multiplicación var*fn = -cte no anda Double", 0
cadena@@62 DB "Multiplicación fn*var = -cte anda Double", 0
cadena@@63 DB "Multiplicación fn*var = -cte no anda Double", 0
cadena@@64 DB "Multiplicación cte*fn = -cte anda Double", 0
cadena@@65 DB "Multiplicación cte*fn = -cte no anda Double", 0
cadena@@66 DB "Multiplicación fn*-cte = -cte anda Double", 0
cadena@@67 DB "Multiplicación fn*-cte = -cte no anda Double", 0
cadena@@68 DB "Multiplicación fn*fn = -cte anda Double", 0
cadena@@69 DB "Multiplicación fn*fn = -cte no anda Double", 0
cadena@@70 DB "Multiplicación var*fn = var anda Double", 0
cadena@@71 DB "Multiplicación var*fn = var no anda Double", 0
cadena@@72 DB "Multiplicación cte*-cte = fn anda Double", 0
cadena@@73 DB "Multiplicación cte*-cte = fn no anda Double", 0
const@@_3_0 DQ -3.0
const@@10_0 DQ 10.0
const@@_30_0 DQ -30.0
const@@_10_0 DQ -10.0
