...
var@@aux73 DD ?
var@@aux31 DD ?
cadena@@562 DB "Suma var = -cte anda Long", 0
cadena@@563 DB "Suma var = -cte no anda Long", 0
cadena@@564 DB "Suma var+var = -cte anda Long", 0
cadena@@565 DB "Suma var+var = -cte no anda Long", 0
cadena@@566 DB "Suma var+-cte = -cte anda Long", 0
cadena@@567 DB "Suma var+-cte = -cte no anda Long", 0
cadena@@568 DB "Suma -cte+var = -cte anda Long", 0
cadena@@569 DB "Suma -cte+var = -cte no anda Long", 0
cadena@@570 DB "Suma -cte+-cte = -cte anda Long", 0
cadena@@571 DB "Suma -cte+-cte = -cte no anda Long", 0
cadena@@572 DB "Suma var+fn = -cte anda Long", 0
cadena@@573 DB "Suma var+fn = -cte no anda Long", 0
cadena@@574 DB "Suma fn+var = -cte anda Long", 0
cadena@@575 DB "Suma fn+var = -cte no anda Long", 0
cadena@@576 DB "Suma -cte+fn = -cte anda Long", 0
cadena@@577 DB "Suma -cte+fn = -cte no anda Long", 0
cadena@@578 DB "Suma fn+-cte = -cte anda Long", 0
cadena@@579 DB "Suma fn+-cte = -cte no anda Long", 0
cadena@@580 DB "Suma fn+fn = -cte anda Long", 0
cadena@@581 DB "Suma fn+fn = -cte no anda Long", 0
cadena@@582 DB "Suma var+fn = var anda Long", 0
cadena@@583 DB "Suma var+fn = var no anda Long", 0
cadena@@584 DB "Suma -cte+-cte = fn anda Long", 0
cadena@@585 DB "Suma -cte+-cte = fn no anda Long", 0
.code
_division_cero:
