...
cadena@@298 DB "Optimiza 1", 0
cadena@@299 DB "Error 1", 0
cadena@@300 DB "Optimiza 2", 0
cadena@@301 DB "Error 2", 0
cadena@@302 DB "Optimiza 3", 0
cadena@@303 DB "Error 3", 0
cadena@@304 DB "Optimiza 4", 0
cadena@@305 DB "Error 4", 0
cadena@@306 DB "Nunca llega if", 0
cadena@@307 DB "nunca llega else", 0
.code
_division_cero:
