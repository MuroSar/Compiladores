...
var@@aux73 DQ ?
var@@aux31 DQ ?
cadena@@156 DB "Multiplicación var = cte anda Double", 0
cadena@@157 DB "Multiplicación var = cte no anda Double", 0
cadena@@158 DB "Multiplicación var*var = cte anda Double", 0
cadena@@159 DB "Multiplicación var*var = cte no anda Double", 0
cadena@@160 DB "Multiplicación var*cte = cte anda Double", 0
cadena@@161 DB "Multiplicación var*cte = cte no anda Double", 0
cadena@@162 DB "Multiplicación cte*var = cte anda Double", 0
cadena@@163 DB "Multiplicación cte*var = cte no anda Double", 0
cadena@@164 DB "Multiplicación cte*cte = cte anda Double", 0
cadena@@165 DB "Multiplicación cte*cte = cte no anda Double", 0
cadena@@166 DB "Multiplicación var*fn = cte anda Double", 0
cadena@@167 DB "Multiplicación var*fn = cte no anda Double", 0
cadena@@168 DB "Multiplicación fn*var = cte anda Double", 0
cadena@@169 DB "Multiplicación fn*var = cte no anda Double", 0
cadena@@170 DB "Multiplicación cte*fn = cte anda Double", 0
cadena@@171 DB "Multiplicación cte*fn = cte no anda Double", 0
cadena@@172 DB "Multiplicación fn*cte = cte anda Double", 0
cadena@@173 DB "Multiplicación fn*cte = cte no anda Double", 0
cadena@@174 DB "Multiplicación fn*fn = cte anda Double", 0
cadena@@175 DB "Multiplicación fn*fn = cte no anda Double", 0
cadena@@176 DB "Multiplicación var*fn = var anda Double", 0
cadena@@177 DB "Multiplicación var*fn = var no anda Double", 0
cadena@@178 DB "Multiplicación cte*cte = fn anda Double", 0
cadena@@179 DB "Multiplicación cte*cte = fn no anda Double", 0
const@@3_0 DQ 3.0
const@@10_0 DQ 10.0
const@@30_0 DQ 30.0
aux_mem_2bytes DW ?
