...
cadena@@334 DB "Resta var = cte anda Double", 0
cadena@@335 DB "Resta var = cte no anda Double", 0
cadena@@336 DB "Resta var-var = cte anda Double", 0
cadena@@337 DB "Resta var-var = cte no anda Double", 0
cadena@@338 DB "Resta var-cte = cte anda Double", 0
cadena@@339 DB "Resta var-cte = cte no anda Double", 0
cadena@@340 DB "Resta cte-var = cte anda Double", 0
cadena@@341 DB "Resta cte-var = cte no anda Double", 0
cadena@@342 DB "Resta cte-cte = cte anda Double", 0
cadena@@343 DB "Resta cte-cte = cte no anda Double", 0
cadena@@344 DB "Resta var-fn = cte anda Double", 0
cadena@@345 DB "Resta var-fn = cte no anda Double", 0
cadena@@346 DB "Resta fn-var = cte anda Double", 0
cadena@@347 DB "Resta fn-var = cte no anda Double", 0
cadena@@348 DB "Resta cte-fn = cte anda Double", 0
cadena@@349 DB "Resta cte-fn = cte no anda Double", 0
cadena@@350 DB "Resta fn-cte = cte anda Double", 0
cadena@@351 DB "Resta fn-cte = cte no anda Double", 0
cadena@@352 DB "Resta fn-fn = cte anda Double", 0
cadena@@353 DB "Resta fn-fn = cte no anda Double", 0
cadena@@354 DB "Resta var-fn = var anda Double", 0
cadena@@355 DB "Resta var-fn = var no anda Double", 0
cadena@@356 DB "Resta cte-cte = fn anda Double", 0
cadena@@357 DB "Resta cte-cte = fn no anda Double", 0
const@@3_0 DQ 3.0
const@@10_0 DQ 10.0
const@@7_0 DQ 7.0
aux_mem_2bytes DW ?
