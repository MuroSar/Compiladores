...
var@@aux73 DD ?
var@@aux31 DD ?
cadena@@130 DB "Division var = -cte anda Long", 0
cadena@@131 DB "Division var = -cte no anda Long", 0
cadena@@132 DB "Division var/var = -cte anda Long", 0
cadena@@133 DB "Division var/var = -cte no anda Long", 0
cadena@@134 DB "Division var/-cte = -cte anda Long", 0
cadena@@135 DB "Division var/cte = -cte no anda Long", 0
cadena@@136 DB "Division -cte/var = -cte anda Long", 0
cadena@@137 DB "Division -cte/var = -cte no anda Long", 0
cadena@@138 DB "Division cte/-cte = -cte anda Long", 0
cadena@@139 DB "Division cte/-cte = -cte no anda Long", 0
cadena@@140 DB "Division var/fn = -cte anda Long", 0
cadena@@141 DB "Division var/fn = -cte no anda Long", 0
cadena@@142 DB "Division fn/var = -cte anda Long", 0
cadena@@143 DB "Division fn/var = -cte no anda Long", 0
cadena@@144 DB "Division -cte/fn = cte anda Long", 0
cadena@@145 DB "Division -cte/fn = cte no anda Long", 0
cadena@@146 DB "Division fn/cte = -cte anda Long", 0
cadena@@147 DB "Division fn/cte = -cte no anda Long", 0
cadena@@148 DB "Division fn/fn = cte anda Long", 0
cadena@@149 DB "Division fn/fn = cte no anda Long", 0
cadena@@150 DB "Division var/fn = var anda Long", 0
cadena@@151 DB "Division var/fn = var no anda Long", 0
cadena@@152 DB "Division -cte/cte = fn anda Long", 0
cadena@@153 DB "Division -cte/cte = fn no anda Long", 0
cadena@@154 DB "Division por cero no anda Long", 0
cadena@@155 DB "Division no anda Long", 0
.code
_division_cero:
