...
var@@aux73 DQ ?
var@@aux31 DQ ?
cadena@@198 DB "Resta var = cte anda Double", 0
cadena@@199 DB "Resta var = cte no anda Double", 0
cadena@@200 DB "Resta var-var = cte anda Double", 0
cadena@@201 DB "Resta var-var = cte no anda Double", 0
cadena@@202 DB "Resta var-cte = cte anda Double", 0
cadena@@203 DB "Resta var-cte = cte no anda Double", 0
cadena@@204 DB "Resta cte-var = cte anda Double", 0
cadena@@205 DB "Resta cte-var = cte no anda Double", 0
cadena@@206 DB "Resta cte-cte = cte anda Double", 0
cadena@@207 DB "Resta cte-cte = cte no anda Double", 0
cadena@@208 DB "Resta var-fn = cte anda Double", 0
cadena@@209 DB "Resta var-fn = cte no anda Double", 0
cadena@@210 DB "Resta fn-var = cte anda Double", 0
cadena@@211 DB "Resta fn-var = cte no anda Double", 0
cadena@@212 DB "Resta cte-fn = cte anda Double", 0
cadena@@213 DB "Resta cte-fn = cte no anda Double", 0
cadena@@214 DB "Resta fn-cte = cte anda Double", 0
cadena@@215 DB "Resta fn-cte = cte no anda Double", 0
cadena@@216 DB "Resta fn-fn = cte anda Double", 0
cadena@@217 DB "Resta fn-fn = cte no anda Double", 0
cadena@@218 DB "Resta var-fn = var anda Double", 0
cadena@@219 DB "Resta var-fn = var no anda Double", 0
cadena@@220 DB "Resta cte-cte = fn anda Double", 0
cadena@@221 DB "Resta cte-cte = fn no anda Double", 0
const@@3_0 DQ 3.0
const@@10_0 DQ 10.0
const@@7_0 DQ 7.0
aux_mem_2bytes DW ?
