...
var@@aux73 DD ?
var@@aux31 DD ?
cadena@@254 DB "Multiplicación var = -cte anda Long", 0
cadena@@255 DB "Multiplicación var = -cte no anda Long", 0
cadena@@256 DB "Multiplicación var*var = -cte anda Long", 0
cadena@@257 DB "Multiplicación var*var = -cte no anda Long", 0
cadena@@258 DB "Multiplicación var*cte = -cte anda Long", 0
cadena@@259 DB "Multiplicación var*cte = -cte no anda Long", 0
cadena@@260 DB "Multiplicación -cte*var = -cte anda Long", 0
cadena@@261 DB "Multiplicación -cte*var = -cte no anda Long", 0
cadena@@262 DB "Multiplicación cte*-cte = -cte anda Long", 0
cadena@@263 DB "Multiplicación cte*-cte = -cte no anda Long", 0
cadena@@264 DB "Multiplicación var*fn = -cte anda Long", 0
cadena@@265 DB "Multiplicación var*fn = -cte no anda Long", 0
cadena@@266 DB "Multiplicación fn*var = -cte anda Long", 0
cadena@@267 DB "Multiplicación fn*var = -cte no anda Long", 0
cadena@@268 DB "Multiplicación cte*fn = -cte anda Long", 0
cadena@@269 DB "Multiplicación cte*fn = -cte no anda Long", 0
cadena@@270 DB "Multiplicación fn*-cte = -cte anda Long", 0
cadena@@271 DB "Multiplicación fn*-cte = -cte no anda Long", 0
cadena@@272 DB "Multiplicación fn*fn = -cte anda Long", 0
cadena@@273 DB "Multiplicación fn*fn = -cte no anda Long", 0
cadena@@274 DB "Multiplicación var*fn = var anda Long", 0
cadena@@275 DB "Multiplicación var*fn = var no anda Long", 0
cadena@@276 DB "Multiplicación cte*-cte = fn anda Long", 0
cadena@@277 DB "Multiplicación cte*-cte = fn no anda Long", 0
.code
_division_cero:
