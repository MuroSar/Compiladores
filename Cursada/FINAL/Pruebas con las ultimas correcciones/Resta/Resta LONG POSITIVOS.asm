...
cadena@@434 DB "Resta var = cte anda Long", 0
cadena@@435 DB "Resta var = cte no anda Long", 0
cadena@@436 DB "Resta var-var = cte anda Long", 0
cadena@@437 DB "Resta var-var = cte no anda Long", 0
cadena@@438 DB "Resta var-cte = cte anda Long", 0
cadena@@439 DB "Resta var-cte = cte no anda Long", 0
cadena@@440 DB "Resta cte-var = cte anda Long", 0
cadena@@441 DB "Resta cte-var = cte no anda Long", 0
cadena@@442 DB "Resta cte-cte = cte anda Long", 0
cadena@@443 DB "Resta cte-cte = cte no anda Long", 0
cadena@@444 DB "Resta var-fn = cte anda Long", 0
cadena@@445 DB "Resta var-fn = cte no anda Long", 0
cadena@@446 DB "Resta fn-var = cte anda Long", 0
cadena@@447 DB "Resta fn-var = cte no anda Long", 0
cadena@@448 DB "Resta cte-fn = cte anda Long", 0
cadena@@449 DB "Resta cte-fn = cte no anda Long", 0
cadena@@450 DB "Resta fn-cte = cte anda Long", 0
cadena@@451 DB "Resta fn-cte = cte no anda Long", 0
cadena@@452 DB "Resta fn-fn = cte anda Long", 0
cadena@@453 DB "Resta fn-fn = cte no anda Long", 0
cadena@@454 DB "Resta var-fn = var anda Long", 0
cadena@@455 DB "Resta var-fn = var no anda Long", 0
cadena@@456 DB "Resta cte-cte = fn anda Long", 0
cadena@@457 DB "Resta cte-cte = fn no anda Long", 0
.code
_division_cero:
