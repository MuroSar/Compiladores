...
var@@aux73 DQ ?
var@@aux31 DQ ?
cadena@@2 DB "Multiplicación var = cte anda Double", 0
cadena@@3 DB "Multiplicación var = cte no anda Double", 0
cadena@@4 DB "Multiplicación var*var = cte anda Double", 0
cadena@@5 DB "Multiplicación var*var = cte no anda Double", 0
cadena@@6 DB "Multiplicación var*-cte = cte anda Double", 0
cadena@@7 DB "Multiplicación var*-cte = cte no anda Double", 0
cadena@@8 DB "Multiplicación -cte*var = cte anda Double", 0
cadena@@9 DB "Multiplicación -cte*var = cte no anda Double", 0
cadena@@10 DB "Multiplicación -cte*-cte = cte anda Double", 0
cadena@@11 DB "Multiplicación -cte*-cte = cte no anda Double", 0
cadena@@12 DB "Multiplicación var*fn = cte anda Double", 0
cadena@@13 DB "Multiplicación var*fn = cte no anda Double", 0
cadena@@14 DB "Multiplicación fn*var = cte anda Double", 0
cadena@@15 DB "Multiplicación fn*var = cte no anda Double", 0
cadena@@16 DB "Multiplicación -cte*fn = cte anda Double", 0
cadena@@17 DB "Multiplicación -cte*fn = cte no anda Double", 0
cadena@@18 DB "Multiplicación fn*-cte = cte anda Double", 0
cadena@@19 DB "Multiplicación fn*-cte = cte no anda Double", 0
cadena@@20 DB "Multiplicación fn*fn = cte anda Double", 0
cadena@@21 DB "Multiplicación fn*fn = cte no anda Double", 0
cadena@@22 DB "Multiplicación var*fn = var anda Double", 0
cadena@@23 DB "Multiplicación var*fn = var no anda Double", 0
cadena@@24 DB "Multiplicación -cte*-cte = fn anda Double", 0
cadena@@25 DB "Multiplicación -cte*-cte = fn no anda Double", 0
const@@_3_0 DQ -3.0
const@@_10_0 DQ -10.0
const@@_30_0 DQ -30.0
const@@30_0 DQ 30.0
