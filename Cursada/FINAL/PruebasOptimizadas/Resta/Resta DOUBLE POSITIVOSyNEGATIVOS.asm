...
var@@aux73 DQ ?
var@@aux31 DQ ?
cadena@@354 DB "Resta var = -cte anda Double", 0
cadena@@355 DB "Resta var = -cte no anda Double", 0
cadena@@356 DB "Resta var-var = -cte anda Double", 0
cadena@@357 DB "Resta var-var = -cte no anda Double", 0
cadena@@358 DB "Resta var-cte = -cte anda Double", 0
cadena@@359 DB "Resta var-cte = -cte no anda Double", 0
cadena@@360 DB "Resta -cte-var = -cte anda Double", 0
cadena@@361 DB "Resta -cte-var = -cte no anda Double", 0
cadena@@362 DB "Resta -cte-cte = -cte anda Double", 0
cadena@@363 DB "Resta -cte-cte = -cte no anda Double", 0
cadena@@364 DB "Resta var-fn = -cte anda Double", 0
cadena@@365 DB "Resta var-fn = -cte no anda Double", 0
cadena@@366 DB "Resta fn-var = -cte anda Double", 0
cadena@@367 DB "Resta fn-var = -cte no anda Double", 0
cadena@@368 DB "Resta -cte-fn = -cte anda Double", 0
cadena@@369 DB "Resta -cte-fn = -cte no anda Double", 0
cadena@@370 DB "Resta fn-cte = -cte anda Double", 0
cadena@@371 DB "Resta fn-cte = -cte no anda Double", 0
cadena@@372 DB "Resta fn-fn = -cte anda Double", 0
cadena@@373 DB "Resta fn-fn = -cte no anda Double", 0
cadena@@374 DB "Resta var-fn = var anda Double", 0
cadena@@375 DB "Resta var-fn = var no anda Double", 0
cadena@@376 DB "Resta -cte-cte = fn anda Double", 0
cadena@@377 DB "Resta -cte-cte = fn no anda Double", 0
const@@3_0 DQ 3.0
const@@_10_0 DQ -10.0
const@@_13_0 DQ -13.0
aux_mem_2bytes DW ?
