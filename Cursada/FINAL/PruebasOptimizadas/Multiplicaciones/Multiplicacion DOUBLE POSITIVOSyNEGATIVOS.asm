...
var@@aux73 DQ ?
var@@aux31 DQ ?
cadena@@208 DB "Multiplicación var = -cte anda Double", 0
cadena@@209 DB "Multiplicación var = -cte no anda Double", 0
cadena@@210 DB "Multiplicación var*var = -cte anda Double", 0
cadena@@211 DB "Multiplicación var*var = -cte no anda Double", 0
cadena@@212 DB "Multiplicación var*cte = -cte anda Double", 0
cadena@@213 DB "Multiplicación var*cte = -cte no anda Double", 0
cadena@@214 DB "Multiplicación -cte*var = -cte anda Double", 0
cadena@@215 DB "Multiplicación -cte*var = -cte no anda Double", 0
cadena@@216 DB "Multiplicación cte*-cte = -cte anda Double", 0
cadena@@217 DB "Multiplicación cte*-cte = -cte no anda Double", 0
cadena@@218 DB "Multiplicación var*fn = -cte anda Double", 0
cadena@@219 DB "Multiplicación var*fn = -cte no anda Double", 0
cadena@@220 DB "Multiplicación fn*var = -cte anda Double", 0
cadena@@221 DB "Multiplicación fn*var = -cte no anda Double", 0
cadena@@222 DB "Multiplicación cte*fn = -cte anda Double", 0
cadena@@223 DB "Multiplicación cte*fn = -cte no anda Double", 0
cadena@@224 DB "Multiplicación fn*-cte = -cte anda Double", 0
cadena@@225 DB "Multiplicación fn*-cte = -cte no anda Double", 0
cadena@@226 DB "Multiplicación fn*fn = -cte anda Double", 0
cadena@@227 DB "Multiplicación fn*fn = -cte no anda Double", 0
cadena@@228 DB "Multiplicación var*fn = var anda Double", 0
cadena@@229 DB "Multiplicación var*fn = var no anda Double", 0
cadena@@230 DB "Multiplicación cte*-cte = fn anda Double", 0
cadena@@231 DB "Multiplicación cte*-cte = fn no anda Double", 0
const@@_3_0 DQ -3.0
const@@10_0 DQ 10.0
const@@_30_0 DQ -30.0
const@@_10_0 DQ -10.0
